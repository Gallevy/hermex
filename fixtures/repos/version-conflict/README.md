...
and the verdict belongs to it. `@hermex/legacy-widget` is looked up as well — since
...
That also means `@hermex/legacy-widget` needs a recorded timeline: without one the
