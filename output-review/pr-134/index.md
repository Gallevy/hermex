...
| Case | Status | Proves |
| --- | --- | --- |
| [`scan-json`](./scan-json.html) | **changed** <span class="or-add">+1</span> <span class="or-del">−83</span> | The full JSON contract: summary.patternCounts (#80), every owned package in packages[], de-duplicated components (#78, #79), and the compliance block (#55). |
| [`scan-json-toggles`](./scan-json-toggles.html) | **changed** <span class="or-add">+1</span> <span class="or-del">−492</span> | What output.* toggles do to --format json: today, nothing (#91). The payload below is emitted with every section switched off, yet still carries packages, components, versus and ruleViolations in full. Pair it with scan-human-minimal to see the two formats diverge; when #91 lands, this baseline shrinking is the proof. |
| [`comply-json`](./comply-json.html) | **changed** <span class="or-add">+1</span> <span class="or-del">−83</span> | The compliance block as machine-readable output on a failing repo. |
| [`comply-all-rule-types-json`](./comply-all-rule-types-json.html) | **changed** <span class="or-add">+1</span> <span class="or-del">−128</span> | The machine-readable shape of every rule type: fieldPath and actualValue on package-field hits, installedRange/requiredRange on require-engine-version, matchedFiles on codeowners. Also where #95 is visible — the two codeowners entries are byte-identical apart from matchedFiles. |
