...
26 cases · 5 changed · 0 invariant breach(es)

## Changed

| Case | Status | Proves |
| --- | --- | --- |
| [`scan-human-all-sections`](./scan-human-all-sections.html) | **changed** <span class="or-add">+6</span> <span class="or-del">−3</span> | Every human section rendered at once, including details and patterns, which the default config leaves off. |
| [`scan-human-charts`](./scan-human-charts.html) | **changed** <span class="or-add">+3</span> <span class="or-del">−1</span> | The bar-chart renderer: bar scaling and label alignment for packages, components and patterns. |
| [`lockfile-npm`](./lockfile-npm.html) | **changed** <span class="or-add">+7</span> <span class="or-del">−2</span> | package-lock.json produces the same inventory as its siblings. |
| [`lockfile-yarn`](./lockfile-yarn.html) | **changed** <span class="or-add">+7</span> <span class="or-del">−2</span> | yarn.lock produces the same inventory as its siblings. |
| [`lockfile-pnpm`](./lockfile-pnpm.html) | **changed** <span class="or-add">+7</span> <span class="or-del">−2</span> | pnpm-lock.yaml produces the same inventory as its siblings. |
