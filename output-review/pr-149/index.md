...
| Case | Status | Proves |
| --- | --- | --- |
| [`scan-json`](./scan-json.html) | **changed** <span class="or-add">+0</span> <span class="or-del">−5</span> | The full JSON contract: summary.patternCounts (#80), every owned package in packages[], de-duplicated components (#78, #79), and the compliance block (#55). |
| [`comply-json`](./comply-json.html) | **changed** <span class="or-add">+0</span> <span class="or-del">−5</span> | The compliance block as machine-readable output on a failing repo. |
| [`lockfile-npm`](./lockfile-npm.html) | **changed** <span class="or-add">+0</span> <span class="or-del">−4</span> | package-lock.json produces the same inventory as its siblings. |
| [`lockfile-yarn`](./lockfile-yarn.html) | **changed** <span class="or-add">+0</span> <span class="or-del">−4</span> | yarn.lock produces the same inventory as its siblings. |
| [`lockfile-pnpm`](./lockfile-pnpm.html) | **changed** <span class="or-add">+0</span> <span class="or-del">−4</span> | pnpm-lock.yaml produces the same inventory as its siblings. |
