...
26 cases · 3 changed · 0 invariant breach(es)
...
| [`comply-release-age`](./comply-release-age.html) | **changed** <span class="or-add">+13</span> <span class="or-del">−13</span> | The flagged-packages table, against a recorded registry: an overdue package with no in-window target (#26), one with a real target, and one merely coming due. |
