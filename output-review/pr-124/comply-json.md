...
**Config** [`fixtures/hermex.config.ts`](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures/hermex.config.ts) · **Fixture** [`fixtures`](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures) ([overview](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures/README.md)) · **Case** [`comply-json`](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures/cases.ts) ([dossier](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures/cases/comply-json.md))

**Expected red** — this baseline is v3's intended output, written before the code that produces it. ruleViolations[].type goes kebab-case — #101. Whether the field is still called `type` is #115 and not settled, so the baseline only changes the ids.
