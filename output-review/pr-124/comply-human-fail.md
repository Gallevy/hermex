...
**Config** [`fixtures/hermex.config.ts`](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures/hermex.config.ts) · **Fixture** [`fixtures`](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures) ([overview](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures/README.md)) · **Case** [`comply-human-fail`](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures/cases.ts) ([dossier](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures/cases/comply-human-fail.md))

**Expected red** — this baseline is v3's intended output, written before the code that produces it. Rule ids go kebab-case — #101. The baseline is the intended table; the run still prints the v2 snake_case ids.

<sub>Reproduce locally: `pnpm run test:output -- --filter comply-human-fail`</sub>

## Config

[`fixtures/hermex.config.ts`](https://github.com/Gallevy/hermex/blob/fb21863914bafd87586d780e1fe768299354844a/fixtures/hermex.config.ts)
...
@@ -22,13 +22,13 @@
 ...
 │ Rule             │ Description                                          │
 ├──────────────────┼──────────────────────────────────────────────────────┤
-│ forbid-packages  │ 🔴 moment is forbidden — Use date-fns or dayjs       │
