...
| Case | Status | Proves |
| --- | --- | --- |
| [`scan-no-files`](./scan-no-files.html) | **changed** <span class="or-add">+0</span> <span class="or-del">−2</span> | The same pipeline failure under `scan` reports the problem and exits 0 — the deliberate asymmetry with comply-exit-2, kept visible so it cannot drift unnoticed. |
