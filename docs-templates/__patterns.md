# <!-- @package name --> - Pattern Detection Reference

Comprehensive reference for all React component usage patterns detected by <!-- @package name -->.
...
When you run `<!-- @cli scan -->`, the pattern statistics show you:
...
<!-- @package name --> detects patterns through static analysis, which means:
...
- [GitHub Repository](<!-- @package repository.url -->) - Source code and issues
